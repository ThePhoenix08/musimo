...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "entity_type",
            sa.Enum("audio_file", "analysis_record", "project", name="entitytype"),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_logs__users"), ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "ix_logs_entity_ref", "logs", ["entity_type", "entity_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.UUID(), nullable=False),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_otps__users"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_refresh_tokens__users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "UPLOADED", "PROCESSING", "PROCESSED", "FAILED", name="audiofilestatus"
            ),
            nullable=False,
        ),
        sa.Column(
            "source_type",
            sa.Enum("ORIGINAL", "SEPARATED", name="audiosourcetype"),
            nullable=False,
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.id"],
            name=op.f("fk_audio_files__projects"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_audio_files__users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["audio_file_id"],
            ["audio_files.id"],
            name=op.f("fk_analysis_records__audio_files"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["model_id"],
            ["models.id"],
            name=op.f("fk_analysis_records__models"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["project_id"],
            ["projects.id"],
            name=op.f("fk_analysis_records__projects"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_analysis_records__users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_analysis_records_audio_file_id"),
        "analysis_records",
        ["audio_file_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_analysis_records_project_id"),
        "analysis_records",
        ["project_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "source_label",
            sa.Enum("VOCALS", "DRUMS", "BASS", "OTHER", name="separatedsourcelabel"),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["parent_audio_id"],
            ["audio_files.id"],
            name=op.f("fk_separated_audio_files__audio_files"),
            ondelete="SET NULL",
        ),
    )
    op.create_index(
        op.f("ix_separated_audio_files_parent_audio_id"),
        "separated_audio_files",
        ["parent_audio_id"],
        unique=False,
    )
    op.create_table(
        "emotion_analysis_records",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["id"],
            ["analysis_records.id"],
            name=op.f("fk_emotion_analysis_records__analysis_records"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"],
            ["analysis_records.id"],
            name=op.f("fk_feature_analysis_records__analysis_records"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_feature_analysis_records")),
    )
    op.create_table(
        "instrument_analysis_records",
        sa.Column("id", sa.UUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["id"],
            ["analysis_records.id"],
            name=op.f("fk_instrument_analysis_records__analysis_records"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["id"],
            ["analysis_records.id"],
            name=op.f("fk_separation_analysis_records__analysis_records"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["feature_analysis_records.id"],
            name=op.f("fk_audio_features__feature_analysis_records"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["audio_file_id"],
            ["audio_files.id"],
            name=op.f("fk_audio_features__audio_files"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_audio_features_FeatureAnalysisRecord"),
        "audio_features",
        ["FeatureAnalysisRecord"],
        unique=False,
    )
    op.create_index(
        op.f("ix_audio_features_audio_file_id"),
        "audio_features",
        ["audio_file_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_audio_features_FeatureAnalysisRecord"), table_name="audio_features"
    )
    ...
    op.drop_index(
        op.f("ix_analysis_records_audio_file_id"), table_name="analysis_records"
    )
