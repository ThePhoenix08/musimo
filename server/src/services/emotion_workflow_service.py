    ...
    async def run(
        ...
        *,
        ...
        try:
            ...
            temp_path = await self._write_temp_file(file_bytes, suffix)
            ...
            # Run model
            # ---------------------------------------------
            result = await self._analysis_service.run_emotion_model(
            ...
            row = await self._analysis_service.upsert_emotion_analysis(
                project_id=project_id,
                audio_file_id=project.main_audio_id,
