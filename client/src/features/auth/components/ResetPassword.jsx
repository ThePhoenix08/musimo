...
export function ResetPasswordDialog({ open, forcedReset, onClose }) {
  ...
  const handleSubmit = async (data) => {
    ...
    apiFormData.append("new_password", data.confirmPassword);

    await flow("resetPassword", apiFormData);

    console.log("Password reset with:", apiFormData);
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent
        showCloseButton={!forcedReset}
        className="sm:max-w-md lg:max-w-4xl lg:max-h-11/12"
      >
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            contains uppercase letters, numbers, and special characters.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="main-content flex gap-6">
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      ...
                      <p className="text-xs text-muted-foreground mt-2">
                        Must contain uppercase letter, number, and special
                        character (!@#$%^&*)
                      </p>
                    </Field>
                  )}
          ...
          <div className="right hidden lg:flex flex-1 items-center justify-center">
            <img
              src="/src/assets/Images/password_reset.png"
