...
class InstrumentDetectionPipeline:
    ...
    def __init__(
        self, model_path: str = None, instruments_path: str = None, config: dict = None
    ):
        """
    ...
    def predict_batch(
        self, audio_paths: list, threshold: float = None
    ) -> Dict[str, Dict]:
        """
    ...
    def health_check(self) -> Dict:
        ...
        try:
            ...
            # Check postprocessor
            health["components"]["postprocessor"] = {"status": "ok"}
