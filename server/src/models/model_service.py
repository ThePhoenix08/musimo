...
class ModelService:
    ...
    @classmethod
    async def predict_emotion_with_progress(
        cls,
        audio_path: str,
        prediction_type: str = "both",
        ...
        """
        Predict emotion from audio file WITH progress tracking
        ...
        # Use the tracked version of predict_async
        result = await cls.emotion_pipeline.predict_async(
            audio_path, prediction_type, tracker=tracker
        )
        return format_prediction_result(result)
        ...
        try:
            ...
            if result.get("success"):
                ...
                formatted_result = {
                    ...
                    "total_detected": data.get("statistics", {}).get(
                ...
                if "processing_time_seconds" in data:
                    formatted_result["processing_time_seconds"] = data[
    ...
    async def predict_both(
        ...
        try:
            ...
            emotion_result = await cls.predict_emotion(
                audio_path, emotion_prediction_type
            )

            # Get instrument prediction
            instrument_result = await cls.predict_instrument(
                audio_path, threshold=instrument_threshold, detailed=False
            )
    ...
    async def health_check(cls) -> Dict:
        ...
        health_status = {
            "emotion_detection": {
                ...
                "status": (
                    "healthy" if cls.emotion_pipeline is not None else "not_initialized"
                ),
            },
            "instrument_detection": {
                ...
                "status": (
                    "healthy"
                    if cls.instrument_pipeline is not None
