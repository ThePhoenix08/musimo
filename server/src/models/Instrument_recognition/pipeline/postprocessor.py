...
class ResultPostprocessor:
    ...
    def format_detailed_response(
        self, results: Dict, include_all: bool = False, audio_info: Dict = None
    ) -> Dict:
        """
    ...
    def _enrich_detections(self, detections: List[Dict]) -> List[Dict]:
        ...
        for detection in detections:
            enriched_item = {
                **detection,
                "confidence_label": self._get_confidence_label(detection["confidence"]),
    ...
    def create_summary_text(self, results: Dict) -> str:
        ...
        summary_parts = [f"Detected {len(detected)} instrument(s):", ""]
    ...
    def format_error_response(
        self, error_message: str, error_type: str = "ProcessingError"
    ) -> Dict:
        """
